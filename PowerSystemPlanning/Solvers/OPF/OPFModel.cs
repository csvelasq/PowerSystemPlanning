...
namespace PowerSystemPlanning.Solvers.OPF
{
    ...
    /// <summary>
    /// Linear programming OPF model considering a variation in load.
    /// </summary>
    /// <remarks>
    /// An OPF model (same as <see cref="OPFModel"/>) where each load is modified according to a constant multiplier.
    /// </remarks>
