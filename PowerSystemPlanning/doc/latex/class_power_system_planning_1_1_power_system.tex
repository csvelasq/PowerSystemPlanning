...
Creates a Power System by reading an X\+ML file, provided the stream. The provided stream must is not closed within this method. I\+O\+Exception and other exceptions are not managed. 
...
\end{DoxyReturn}
\index{Power\+System\+Planning\+::\+Power\+System@{Power\+System\+Planning\+::\+Power\+System}!save\+To\+X\+M\+L\+File@{save\+To\+X\+M\+L\+File}}
...
Saves the current power sysem to an X\+ML file, provided the stream. The provided stream must is not closed within this method. I\+O\+Exception and other exceptions are not managed. 
